...
int train()
{
  ...
  {
		boost::shared_ptr<caffe::SolverCNN > solver_cnn(new caffe::SolverCNN(solver_param));
	...
	{
		boost::shared_ptr<caffe::SolverGAN > solver_gan(new caffe::SolverGAN(solver_param));
		if (FLAGS_snapshot.size())
		{
		  LOG(INFO) << "Resuming from " << FLAGS_snapshot;
	...
	{
		boost::shared_ptr<caffe::SolverSecGAN> solver_gan(new caffe::SolverSecGAN(solver_param));
		if (FLAGS_snapshot.size())
		{
		  LOG(INFO) << "Resuming from " << FLAGS_snapshot;
		  solver_gan->Restore(FLAGS_snapshot.c_str());
	...
	{
		boost::shared_ptr<caffe::SolverAuxSecGAN> solver_gan(new caffe::SolverAuxSecGAN(solver_param));
		if (FLAGS_snapshot.size())
		{
		  LOG(INFO) << "Resuming from " << FLAGS_snapshot;
		  solver_gan->Restore(FLAGS_snapshot.c_str());
