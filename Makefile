...
INCLUDE_DIRS := /home/shen/caffe/thirdparty/cudnn/include . src /usr/local/include $(CUDA_INCLUDE_DIR)  include /home/shen/caffe/thirdparty/nccl/include /home/shen/caffe/thirdparty/blas/include /home/shen/caffe/thirdparty/mpich/include /usr/local/lib/python3.6/dist-packages/numpy/core/include
...
LIBRARIES := glog gflags protobuf boost_system boost_filesystem boost_regex m  opencv_core opencv_highgui opencv_imgproc opencv_imgcodecs boost_thread stdc++  cudnn openblas
...
#---------------------------------------------  python -------------------------------------------------
pycaffe: all
	$(CXX) -I/usr/local/lib/python3.6/site-packages/numpy/core/include/ $(CXXFLAGS)  $(COMMON_FLAGS) -shared  python/_pycaffe.cpp -lboost_python-py36 \
	-I/usr/include/python3.6/  -Wl,--whole-archive lib$(PROJECT).a -Wl,--no-whole-archive  \
